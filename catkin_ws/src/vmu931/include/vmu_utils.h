...
#define VMU_SIZE_OFFS 1     ///< Second byte of a message (contains the size of the message)
#define VMU_TYPE_OFFS 2     ///< Third byte of a message (contains the type of data in the message)
/// @}
...
/// \cond
extern const int i; // Endianness verification
