...
int connect_to_serial_port(const char device_filename[], int serial_baudrate) {
...
int main(int argc, char** argv) {
    ...
    ros::NodeHandle nh;
    ros::Publisher pub_vmu931 = nh.advertise<vmu931::vmu931_data>("/vmu931", 10);
    ...
    vmu931::vmu931_data vmu931_data;
    vmu931_data.header.frame_id = frame_id;
