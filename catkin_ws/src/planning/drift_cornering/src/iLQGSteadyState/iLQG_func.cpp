/* File generated form template iLQG_func.tem on 2018-05-09 20:15:48-04:00. Do not edit! */

namespace steadystate {

#include "iLQGSteadyState/iLQG.h"
#include "iLQGSteadyState/matMult.h"
#include <math.h>
...
tParamDesc p_name9= {"dt", 1, 0}; // -> p[8][0]
tParamDesc p_name10= {"goal", 3, 0}; // -> p[9][0]
tParamDesc p_name11= {"limSteer", 2, 0}; // -> p[10][0]
tParamDesc p_name12= {"limThr", 2, 0}; // -> p[11][0]
tParamDesc p_name13= {"load_f", 1, 0}; // -> p[12][0]
tParamDesc p_name14= {"load_r", 1, 0}; // -> p[13][0]
tParamDesc p_name15= {"m", 1, 0}; // -> p[14][0]
tParamDesc p_name16= {"mu", 1, 0}; // -> p[15][0]
tParamDesc p_name17= {"mu_s", 1, 0}; // -> p[16][0]
tParamDesc p_name18= {"pf", 3, 0}; // -> p[17][0]
int n_vars= 0;
    
tParamDesc *paramdesc[]= {&p_name1, &p_name2, &p_name3, &p_name4, &p_name5, &p_name6, &p_name7, &p_name8, &p_name9, &p_name10, &p_name11, &p_name12, &p_name13, &p_name14, &p_name15, &p_name16, &p_name17, &p_name18};
...
static int ddpL(trajEl_t *t, int k, tOptSet *o) {
    ...
    t->c=pow(u[0],2.0)*p[7][0]+pow(u[1],2.0)*p[7][1]+p[5][0]*pow((u[0]-x[6])/p[8][0],2.0)+p[5][1]*pow((u[1]-x[7])/p[8][0],2.0)+p[6][0]*(-p[17][0]+sqrt(pow(x[3]-p[9][0],2.0)+pow(p[17][0],2.0)))+p[6][2]*(-p[17][2]+sqrt(pow(x[5]-p[9][2],2.0)+pow(p[17][2],2.0)))+p[6][1]*(-p[17][1]+sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0)));
    if (isNANorINF(t->c))
        {
...
static int ddpF(trajFin_t *t, tOptSet *o) {
    ...
    t->c=p[6][0]*(-p[17][0]+sqrt(pow(x[3]-p[9][0],2.0)+pow(p[17][0],2.0)))+p[6][2]*(-p[17][2]+sqrt(pow(x[5]-p[9][2],2.0)+pow(p[17][2],2.0)))+p[6][1]*(-p[17][1]+sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0)));
    if (isNANorINF(t->c))
        {
            PRNT("    @k %d: t->c in line %d is nan or inf: %g\n", k, __LINE__-3,t->c);
            {
...
static int ddpf(double x_next[], trajEl_t *t, int k, double **p, int N) {
    ...
    x_next[0]=x[0]+sqrt(pow(x[3],2.0)+pow(x[4],2.0))*p[8][0]*cos(x[2]+atan2(x[4],x[3]));
    ...
    x_next[1]=x[1]+sqrt(pow(x[3],2.0)+pow(x[4],2.0))*p[8][0]*sin(x[2]+atan2(x[4],x[3]));
    ...
    x_next[3]=x[3]+p[8][0]*(x[4]*x[5]+((u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/(0.001+abs(x[3]))/(1.0+(u[0]-
     x[3])/(0.001+abs(x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0]);
    ...
    x_next[4]=x[4]+p[8][0]*(-x[3]*x[5]+(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/x[3]/(1.0+(u[0]-x[3
     ])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0]);
    ...
    x_next[5]=x[5]+p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/x[3]/(1.0+(u[0]-x[3])/(
     0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
...
// df[i]/d x[1]
// df[i]/d x[2]
    t->fx[16]=-sqrt(pow(x[3],2.0)+pow(x[4],2.0))*p[8][0]*sin(x[2]+atan2(x[4],x[3]));
    ...
    t->fx[17]=sqrt(pow(x[3],2.0)+pow(x[4],2.0))*p[8][0]*cos(x[2]+atan2(x[4],x[3]));
...
// df[i]/d x[3]
    t->fx[24]=x[3]*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0))+x[4]*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fx[25]=-x[4]*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0))+x[3]*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fx[27]=1.0+p[8][0]*(-p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))
     ...
     ])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+(u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]
     ),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0
     )+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-
     x[3])/(0.001+abs(x[3]))),2.0),1.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.1111111111111111*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0)
     )/p[12][0]/p[15][0],1,(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fx[28]=p[8][0]*(-x[5]+(p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/pow(x[3],2.0)/(1.0+(u[0]-x[3])
     ...
     3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.1111111111111111*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15
     ][0],1,(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0]);
    ...
    t->fx[29]=p[8][0]*(-p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/pow(x[3],2.0)/(1.0+(u[0]-x[3
     ...
     0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001
     +abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[
     3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.1111111111111111*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*
     x[5],2.0))/p[12][0]/p[15][0],1,(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
...
// df[i]/d x[4]
    t->fx[32]=x[4]*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0))-x[3]*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fx[33]=x[3]*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0))+x[4]*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fx[35]=p[8][0]*(x[5]+((u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5]
     )/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-x[3]*p[12][0]*p[15
     ][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0]);
    ...
    t->fx[36]=1.0+p[8][0]*(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][
     ...
     /(0.001+abs(x[3]))),2.0)))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5
     ],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fx[37]=p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[
     ...
     (u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+
     pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
...
// df[i]/d x[5]
    t->fx[43]=p[8][0]*(x[4]+((u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0
     )*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[
     1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-p[1][0]*x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0]);
    ...
    t->fx[44]=p[8][0]*(-x[3]+(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p
     ...
     p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[
     15][0],1,-p[1][0]*x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0]);
    ...
    t->fx[45]=1.0+p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+
     ...
     2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*
     x[5],2.0))/p[12][0]/p[15][0],1,-p[1][0]*x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
...
// df[i]/d u[1]
    t->fu[11]=p[8][0]*(-cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)+0.1111111111111111*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0]
     -0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,p[12][0]*p[15][0]/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fu[12]=p[8][0]*(-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)+0.1111111111111111*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0]
     -0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,p[12][0]*p[15][0]/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fu[13]=p[8][0]*(-p[1][0]*sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)+0.1111111111111111*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[
     15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,p[12][0]*p[15][0]/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
...
// j= 1
// j= 2
    t->fxx[5]=-sqrt(pow(x[3],2.0)+pow(x[4],2.0))*p[8][0]*cos(x[2]+atan2(x[4],x[3]));
...
// j= 3
    t->fxx[8]=x[4]*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0))-x[3]*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fxx[9]=-pow(x[3],2.0)*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)-pow(x[4],2.0)*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)+p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
...
// j= 4
    t->fxx[12]=-x[3]*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0))-x[4]*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fxx[13]=-pow(x[3],2.0)*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)-pow(x[4],2.0)*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)+p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fxx[14]=-pow(x[3],2.0)*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)-pow(x[4],2.0)*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)+p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
...
// j= 1
// j= 2
    t->fxx[41]=-sqrt(pow(x[3],2.0)+pow(x[4],2.0))*p[8][0]*sin(x[2]+atan2(x[4],x[3]));
...
// j= 3
    t->fxx[44]=x[3]*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0))+x[4]*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fxx[45]=-pow(x[3],2.0)*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)-pow(x[4],2.0)*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)+p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
...
// j= 4
    t->fxx[48]=x[4]*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0))-x[3]*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fxx[49]=pow(x[3],2.0)*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)+pow(x[4],2.0)*p[8][0]*cos(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)-p[8][0]*cos(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
    ...
    t->fxx[50]=-pow(x[3],2.0)*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)-pow(x[4],2.0)*p[8][0]*sin(x[2]+atan2(x[4],x[3]))/pow(pow(x[3],2.0)+pow(x[4],2.0),1.5)+p[8][0]*sin(x[2]+atan2(x[4],x[3]))/sqrt(pow(x[3],2.0)+pow(x[4],2.0));
...
// j= 2
// j= 3
    t->fxx[117]=p[8][0]*(-(u[0]-x[3])*p[4][0]*mcond(x[3]>0.0,0.0,1,0.0)*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/pow(0.001+abs(x[
     ...
     -x[3])*mcond(x[3]>0.0,0.0,1,0.0)/pow(0.001+abs(x[3]),2.0)+2.0*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0)+2.0*(u[0]-x[3])*pow(mcond(x[3]>0.0,1.0,1,-1.0),2.0)/pow(0.001+abs(x[3]),3.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+2.0*(x[4]-p[2][0]*x[5])*pow(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0),2.0)/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[4][0],2.0)*pow(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0),2.0)/pow(0.001+abs(x[3]),2.0)+2.0*pow(p[3][0],2.0)*pow(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0),2.0))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3]
     )/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))+0.08333333333333333*pow(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/p[13][0]/p[15][0]/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),
     2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,0.0,1,0.0)/pow(0.001+abs(x[3]),3.0)-8.0*(u[0]-x[3])*pow(p[4][0],2.0)*mcond(x[3]>0.0,1.0,1,-1.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),3.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+6.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*pow(mcond(x[3]>0.0,1.0,1,-1.0),2.0)/pow(0.001+abs(x[3]),4.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(2.0*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-(u[0]-x[3])*(-(u[0]-x[3])*mcond(x[3]>0.0,0.0,1,0.0)/pow(0.001+abs(x[3]),2.0)+2.0*mcond(x[3]>0.0,1.0,1,-1.0
     ...
     4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])
     ),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*p[3][0]*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-0.2222222222222222*pow(p[3][0],3.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[
     1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*x[3]*pow(p[3][0],
     2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,-2.0*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+2.0*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][
     0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// j= 4
    t->fxx[121]=p[8][0]*(-p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[
     ...
     0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))+0.16666666666666666*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001
     +abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5),1,-0.5*p[13][0]*p[16][0]*(2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-1/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)+1.5*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+
     ...
     )*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,-2.0*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+2.0*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(
     x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fxx[122]=p[8][0]*((u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.3333333333333333*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]
     -x[3])/(0.001+abs(x[3]))),2.0)),1,3.0*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)*p[13][0]*p[16][0]/pow(x[3],4.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)-pow(p[3][0],2.0)*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*pow(x[3],2.0)*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))
     ,2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-0.2222222222222222*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]
     /p[15][0]+0.6666666666666666*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[
     1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,2.0*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-2.0*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// j= 5
    t->fxx[126]=p[8][0]*(-p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2
     ...
     [1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*p[1][0]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,-2.0*p[1][0]*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1
     ][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+2.0*p[1][0]*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[1][0]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fxx[127]=p[8][0]*(1.0+((u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*p[2][0]*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]
     -p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-3.0*p[2][0]*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)*p[13][0]*p[16][0]/pow(x[3],4.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)+p[2][0]*pow(p[3][0],2.0)*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*p[1][0]*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*p[1][0]*pow
     ...
     atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*p[1][0]*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,2.0*p[1][0]*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-2.0*p[1][0]*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0]);
    ...
    t->fxx[128]=p[8][0]*((u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[2][0],2.0)*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*pow(p[2][0],2.0)*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.3333333333333333*pow(p[2][0],2.0)*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p
     [3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,3.0*pow(p[2][0],2.0)*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)*p[13][0]*p[16][0]/pow(x[3],4.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)-pow(p[2][0],2.0)*pow(p[3][0],2.0)*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*pow(p[1][0],2.0)*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+
     pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*pow(p[1][0],2.0)*pow(x[3],2.0)*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-0.2222222222222222*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*pow(p[1][0],2.0)*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*pow(p[1][0],2.0)*x[3]*pow(
     p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]
     -0.6666666666666666*pow(p[1][0],2.0)*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,2.0*pow(p[1][0],2.0)*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-2.0*pow(p[1][0],2.0)*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(
     -u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// j= 2
// j= 3
    t->fxx[153]=p[8][0]*(-2.0*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/pow(x[3],3.0)/(1.0+(u[0]-x[3])
     ...
     0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0),2.0)/pow(0.001+abs(x[3]),2.0)+2.0*pow(p[3][0],2.0)*pow(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0),2.0))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)+0.75*p[13][0]*p[16][0]*pow(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(
     x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*p[3][0]*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]
     *x[5],2.0),2.0)-0.2222222222222222*pow(p[3][0],3.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(x[4]+
     p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0
     ),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,-2.0*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+2.0*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// j= 4
    t->fxx[157]=p[8][0]*(p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*
     ...
     >0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[3][0]*pow(x[4]+p[1][0]*x[5]
     ,2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)+p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+2.0*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)+0.2222222222222222*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.1111111111111111*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(
     ...
     3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,-2.0*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+2.0*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+
     atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fxx[158]=p[8][0]*(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.3333333333333333*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(
     1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,3.0*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)*p[13][0]*p[16][0]/pow(x[3],4.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)-pow(p[3][0],2.0)*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-2.0*p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/
     pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*pow(x[
...
// j= 5
    t->fxx[162]=p[8][0]*(-1.0+(p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p
     ...
     2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+
     ...
     2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(
     1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[
     0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[1][0]*p[3][0]*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)+p[1][0]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+2.0*p[1][0]*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*p[1][0]*pow(p[3][0],3.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(
     x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.1111111111111111*p[1][0]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*p[1][0]*pow(p[3][0],2.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*p[1][0]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],
     ...
     pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*p[1][0]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,-2.0*p[1][0]*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0
    ...
    t->fxx[163]=p[8][0]*(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*p[2][0]*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((
     x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-3.0*p[2][0]*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)*p[13][0]*p[16][0]/pow(x[3],4.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)+p[2][0]*pow(p[3][0],2.0)*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[2][0]*p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[
     ...
     ))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*p[1][0]*x[3]*p[
     3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*p[1][0]*pow(x[3],2.0)*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-0.2222222222222222*p[1][0]*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*p[1][0]*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],
     2.0)/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*p[1][0]*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*p[1][0]*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/
     p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*p[1][0]*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,2.0*p[1][0]*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-2.0*p[1][0]*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>
     0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fxx[164]=p[8][0]*(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[2][0],2.0)*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*pow(p[2][0],2.0)*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.3333333333333333*pow(p[2][0],2.0)*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),
     ...
     3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*pow(p[1][0],2.0)*x[3]*p[3]
     ...
     [3]))-2.0*pow(p[1][0],2.0)*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// j= 2
// j= 3
    t->fxx[189]=p[8][0]*(2.0*p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/pow(x[3],3.0)/(1.0+(u[0
     ...
     *(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-2.0*p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]
     ...
     0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-(u[0]-x[3])*(-(u[0]-x[3])*mcond(x[3]>0.0,0.0,1,0.0)/pow(0.001+abs(x[3]),2.0)+2.0*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0)+2.0*(u[0]-x[3])*pow(mcond(x[3]>0.0,1.0,1,-1.0),2.0)/pow(0.001+abs(x[3]),3.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+2.0*(u[0]-x[3])*pow(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(2.0*(x[4]-p[2][0]*x[5])/pow(x[3],3.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-(x[4]-p[2][0]*x[5])*(-(u[0]-x[3])*mcond(x[3]>0.0,0.0,1,0.0)/pow(0.001+abs(x[3]),2.0)+2.0*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0)+2.0*(u[0]-x[3])*pow(mcond(x[3]>0.0,
     1.0,1,-1.0),2.0)/pow(0.001+abs(x[3]),3.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+2.0*(x[4]-p[2][0]*x[5])*pow(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0),2.0)/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[4][0],2.0)*pow(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0),2.0)/pow(0.001+abs(x[3]),2.0)+2.0*pow(p[3][0],2.0)*pow(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0),2.0))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))
     ,2.0))+0.08333333333333333*pow(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/p[13][0]/p[15][0]/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5),1,-0.5*p[13][0]*p[16][0]*(
     -2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,0.0,1,0.0)/pow(0.001+abs(x[3]),3.0)-8.0*(u[0]-x[3])*pow(p[4][0],2.0)*mcond(x[3]>0.0,1.0,1,-1.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),3.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+6.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*pow(mcond(x[3]>0.0,1.0,1,-1.0),2.0)/pow(0.001+abs(x[3]),4.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(2.0*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-(u[0]-x[3])*(-(u[0]-x[3])*mcond(x[3]>0.0,0.0,1,0.0)/pow(0.001+abs(x[3]),2.0)+2.0*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0)+2.0*(u[0]-x[3])*pow(mcond(x[3]>0.0,1.0,1,-1.0),2.0)/pow(0.001+abs(x[3]),3.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+
     ...
     )/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*p[3][0]*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[
...
// j= 4
    t->fxx[193]=p[8][0]*(-p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]
     ...
     u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(
     p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-
     x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15
     ][0]/p[3][0]),-2.0*p[3][0]*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)+p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+2.0*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)+0.2222222222222222*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.1111111111111111*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan
     (-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]
     +p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[
     1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,-2.0*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+2.0*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5]
     ,x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
    ...
    t->fxx[194]=p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.3333333333333333*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])
     /x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,3.0*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)*p[13][0]*p[16][0]/pow(x[3],4.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)-pow(p[3][0],2.0)*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*p[2][0]*p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/
     pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5
...
// j= 5
    t->fxx[198]=p[8][0]*(-p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+
     ...
     x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[
     3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(
     0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[1][0]*p[3][0]*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)+p[1][0]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+2.0*p[1][0]*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*p[1][0]*pow(p[3][0],3.0)*pow(x[4]+p[1][0]*x[5],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[
     ...
     0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.3333333333333333*p[1][0]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,-2.0*p[1][0]*pow(x[4]+p[1][0]*x[5],2.0)*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[
    ...
    t->fxx[199]=p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*p[2][0]*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0
     )*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-3.0*p[2][0]*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)*p[13][0]*p[16][0]/pow(x[3],4.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)+p[2][0]*pow(p[3][0],2.0)*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-pow(p[2][0],2.0)*p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],
     0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[2][0]*p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3
     ]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12
     ][0]*p[15][0]/p[3][0]),2.0*p[1][0]*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*p[1][0]*pow(x[3],2.0)*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-0.2222222222222222*p[1][0]*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*p[1][0]*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow(x[3],2.0)+pow(
     x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*p[1][0]*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*p[1][0]*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+
     pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*p[1][0]*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,2.0*p[1][0]*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-2.0*p[1][0]*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*
    ...
    t->fxx[200]=p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[2][0],2.0)*pow(p[3][0],2.0)/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*pow(p[2][0],2.0)*pow(p[3][0],4.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],4.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.3333333333333333*pow(p[2][0],2.0)*pow(p[3][0],2.0)/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(
     ...
     x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*pow
     (p[1][0],2.0)*x[3]*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-2.0*pow(p[1][0],2.0)*pow(x[3],2.0)*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)-0.2222222222222222*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*pow(p[1][0],2.0)*x[3]*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(pow
     (x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*pow(p[1][0],2.0)*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1]
     [0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]-0.6666666666666666*pow(p[1][0],2.0)*x[3]*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[1][0],2.0)*pow(x[3],2.0)*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/p[12][0]/p[15][0],1,2.0*pow(p[1][0],2.0)*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+
     atan2(x[4]+p[1][0]*x[5],x[3]))-2.0*pow(p[1][0],2.0)*x[3]*(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/pow(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0),2.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
...
// j= 0
     ...
     *(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0
...
// j= 1
    t->fuu[11]=p[8][0]*(sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))-2.0*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)+0.1111111111111111*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0]
     -0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,p[12][0]*p[15][0]/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.2222222222222222*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]
     +atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// d^2f[4]/du[i] du[j]
// j= 0
    t->fuu[12]=p[8][0]*(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(6.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(2.0*(u[0]-x[3])/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)-2.0/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[4][0],2.0)*pow(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(6.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3
     ...
     3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0
...
// j= 1
    t->fuu[14]=p[8][0]*(-cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))-2.0*sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)+0.1111111111111111*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0]
     -0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,p[12][0]*p[15][0]/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.2222222222222222*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]
     +atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// d^2f[5]/du[i] du[j]
// j= 0
    t->fuu[15]=p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(6.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(2.0*(u[0]-x[3])/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)-2.0/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[4][0],2.0)*pow(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(6.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u
     [0]-x[3])/(0.001+abs(x[3])),4.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(2.0*(u[0]-x[3])/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)-2.0/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[4][0],2.0)*pow(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))+0.08333333333333333*pow(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(
     0.001+abs(x[3]))),2.0)/p[13][0]/p[15][0]/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5),1,-0.5*p[13][0]*p[16][0]*(6.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),4.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(2.0*(u[0]-x[3])/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)-2.0/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[4][0],2.0)*pow(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),
...
// j= 1
    t->fuu[17]=p[8][0]*(-p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[3][0]*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.037037037037037035*pow(p[3][0],3.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*pow(p[3][0],2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))-2.0*p[1][0]*sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)+0.1111111111111111*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0
     ]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,p[12][0]*p[15][0]/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-0.2222222222222222*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3
     ])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/p[12][0]/p[15][0],1,-p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
...
// j= 0
    t->fxu[51]=p[8][0]*(-p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p
     ...
     (1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))+0.08333333333333333*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/
     (0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5),1,-0.5*p[13][0]*p[16][0]*(-4.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*((x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+(x[4]-p[2][0]*x[5])*mcond(x[3]>0.0,1.0,1,-1.0)/x[3]/
     ...
     +(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(
     0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x
     [3])/(0.001+abs(x[3]))))/p[14][0];
    ...
    t->fxu[52]=p[8][0]*((u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.14814814814814814*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+0.16666666666666666*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),
     2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)+0.6666666666666666*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,1.5*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+
     ...
     ]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/(0.001+abs(x[3]))/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[14][0];
    ...
    t->fxu[53]=p[8][0]*((u[0]-x[3])*p[4][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.14814814814814814*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)-0.16666666666666666*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(
     0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.6666666666666666*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-1.5*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))
...
// j= 1
    t->fxu[59]=p[8][0]*(-cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.1111111111111111*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/(pow(x[3],
     2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.2222222222222222*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*(x[
     4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],
     1,-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fxu[60]=p[8][0]*(-cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))
     +x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.2222222222222222*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3
     ])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fxu[61]=p[8][0]*(-cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-p[1][0]*x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/
     abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*
     tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0
     )/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// d^2f[4]/dx[i] du[j]
// j= 0
    t->fxu[67]=p[8][0]*(p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(
     0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[3][0]*(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(
     1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(
     0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+
     ...
     [0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-4.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*((x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+(x[4]-p[2][0]*x[5])*mcond(x[3]>0.0,1.0,1,-1.0)/x[3]/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+2.0*(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(1/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3]))
     ...
     ])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))+0.08333333333333333*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[
     3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5),1,-0.5*p[13][0]*p[16][0]*(-4.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*((x[4]-p[2][0]*x[5
     ...
     -1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*
     pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/
     pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/p[14][0];
    ...
    t->fxu[68]=p[8][0]*(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.14814814814814814*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+0.16666666666666666*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs
     (x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)+0.6666666666666666*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,1.5*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),
     2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),
     ...
     /(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3
     ])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2
     ][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/x[3]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/p[14][0];
    ...
    t->fxu[69]=p[8][0]*(-p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.14814814814814814*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)-0.16666666666666666*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0
     )/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.6666666666666666*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-1.5*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x
     [3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)-2.0*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p
...
// j= 1
    t->fxu[75]=p[8][0]*(-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.1111111111111111*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/(pow(x[3],
     2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.2222222222222222*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*(x[
     4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.6666666666666666*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],
     1,-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fxu[76]=p[8][0]*(-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))
     +x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.2222222222222222*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3
     ])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
    ...
    t->fxu[77]=p[8][0]*(-sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-p[1][0]*x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/
     abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*
     tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0
     )/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[14][0];
...
// j= 0
     ...
     *(x[4]-p[2][0]*x[5])*((x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+(x[4]-p[2][0]*x[5])*mcond(x[3]>0.0,1.0,1,-1.0)/x[3]/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+2.0*(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(1/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+2.0*(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)-(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3]
     ...
     ))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-1/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(u[0]-x[3])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-(x[4]-p[2][0]*x[5])*(-1/(0.001+abs(x[3]))-(u[0]-x[3])*mcond(x[3]>0.0,1.0,1,-1.0)/pow(0.001+abs(x[3]),2.0))/x[3]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3]
    ...
    t->fxu[84]=p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.14814814814814814*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+0.16666666666666666*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(
     0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)+0.6666666666666666*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,1.5*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+
     abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)+2.0*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.07407407407407407*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-0.3333333333333333*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(
     0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+p[2][0]*p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p
     [4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs
    ...
    t->fxu[85]=p[8][0]*(p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.14814814814814814*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)-0.16666666666666666*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]
     ))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5)-0.6666666666666666*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/p[13][0]/p[15][0]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-1.5*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(
     0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),2.5)-2.0*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))-p[2][0]*p[3][0]*(x[4]-p[2][0]*x[5])*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],-0.07407407407407407*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])/pow(x[3],2.0)/pow(p[13][0],2.0)/pow(p[15][0],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+0.3333333333333333*p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[
     5])/pow(x[3],2.0)/p[13][0]/p[15][0]/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,p[2][0]*pow(p[3][0],2.0)*(x[4]-p[2][0]*x[5])*p[13][0]*p[16][0]/pow(x[3],2.0)/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)-pow(p[2][0],2.0)*p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],0.037037037037037035*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+
     abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.16666666666666666*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/p[13][0]/p[15][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)),1,-0.5*p[13][0]*p[16][0]*(-2.0*pow(p[3][0],2.0)*pow(x[4]-p[2][0]*x[5],2.0)/pow(x[3],2.0)/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(
     0.001+abs(x[3])),3.0)+2.0*(u[0]-x[3])*pow(p[4][0],2.0)*(-(u[0]-x[3])/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0)+1/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(0.001+abs(x[3]),2.0)/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))))/pow(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0),1.5))/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3])))+pow(p[2][0],2.0)*p[3][0]*mcond(sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))<=3.0*p[13][0]*p[15][0],1.0+0.037037037037037035*(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/pow(p[13][0],2.0)/pow(p[15][0],2.0)-0.3333333333333333*sqrt(pow(p[4]
     [0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0))/p[13][0]/p[15][0],1,p[13][0]*p[16][0]/sqrt(pow(p[4][0],2.0)*pow((u[0]-x[3])/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)/pow(0.001+abs(x[3]),2.0)+pow(p[3][0],2.0)*pow((x[4]-p[2][0]*x[5])/x[3]/(1.0+(u[0]-x[3])/(0.001+abs(x[3]))),2.0)))/x[3]/(0.001+abs(x[3]))/pow(1.0+(u[0]-x[3])/(0.001+abs(x[3])),2.0))/p[0][0];
...
// j= 1
    t->fxu[91]=p[8][0]*(-p[1][0]*sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.1111111111111111*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.3333333333333333*pow(p[3][0],2.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]/(
     pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-2.0*p[3][0]*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.2222222222222222*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.2222222222222222*pow(p[3][0],3.0)*(x[4]+p[1][0]*x[5])*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.6666666666666666*pow
     ...
     [12][0]/p[15][0],1,-(x[4]+p[1][0]*x[5])*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))))/p[0][0];
    ...
    t->fxu[92]=p[8][0]*(-p[1][0]*sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5
     ],x[3]))+x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.2222222222222222*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+
    ...
    t->fxu[93]=p[8][0]*(-p[1][0]*sin(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),-p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))-0.1111111111111111*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,-p[1][0]*x[3]*p[12][0]*p[15][0]/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5
     ],2.0))/abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))+p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))+p[1][0]*cos(u[1])*mcond(abs(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))<=atan(3.0*p[12][0]*p[15][0]/p[3][0]),2.0*p[1][0]*x[3]*p[3][0]*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]+0.2222222222222222*p[1][0]*x[3]*pow(p[3][0],3.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),3.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/pow(p[12][0],2.0)/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5
     ],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*abs(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])))/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]+0.3333333333333333*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,0.0,1,0.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),4.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0]-0.6666666666666666*p[1][0]*x[3]*pow(p[3][0],2.0)*pow(sec(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*pow(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])),2.0)*mcond(tan(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3]))>0.0,1.0,1,-1.0)/(pow(x[3],2.0)+pow(x[4]+p[1][0]*x[5],2.0))/p[12][0]/p[15][0],1,p[1][0]*x[3]*p[12][0]*p[15][0]*mcond(-u[1]+atan2(x[4]+p[1][0]*x[5],x[3])
...
// derivatives of L
    ...
    t->cx[1]=0.0;
    t->cx[2]=0.0;
    t->cx[3]=p[6][0]*(x[3]-p[9][0])/sqrt(pow(x[3]-p[9][0],2.0)+pow(p[17][0],2.0))-x[4]*p[6][1]*(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]))/(pow(x[3],2.0)+pow(x[4],2.0))/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0));
    ...
    t->cx[4]=x[3]*p[6][1]*(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]))/(pow(x[3],2.0)+pow(x[4],2.0))/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0));
    ...
    t->cx[5]=p[6][2]*(x[5]-p[9][2])/sqrt(pow(x[5]-p[9][2],2.0)+pow(p[17][2],2.0));
    ...
    t->cx[6]=-2.0*p[5][0]*(u[0]-x[6])/pow(p[8][0],2.0);
    ...
    t->cx[7]=-2.0*p[5][1]*(u[1]-x[7])/pow(p[8][0],2.0);
    ...
    t->cxx[7]=0.0;
    t->cxx[8]=0.0;
    t->cxx[9]=-p[6][0]*pow(x[3]-p[9][0],2.0)/pow(pow(x[3]-p[9][0],2.0)+pow(p[17][0],2.0),1.5)+p[6][0]/sqrt(pow(x[3]-p[9][0],2.0)+pow(p[17][0],2.0))+pow(x[4],2.0)*p[6][1]/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0))-pow(x[4],2.0)*p[6][1]*pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0)/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/pow(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0),1.5)+2.0*x[3]*x[4]*p[6][1]*(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]))/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0));
    ...
    t->cxx[11]=0.0;
    t->cxx[12]=0.0;
    t->cxx[13]=-x[3]*x[4]*p[6][1]/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0))+x[3]*x[4]*p[6][1]*pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0)/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/pow(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0),1.5)+2.0*pow(x[4],2.0)*p[6][1]*(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]))/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0))-p[6][1]*(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]))/(pow(x[3],2.0)+pow(x[4],2.0))/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0));
    ...
    t->cxx[14]=pow(x[3],2.0)*p[6][1]/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0))-pow(x[3],2.0)*p[6][1]*pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0)/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/pow(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0),1.5)-2.0*x[3]*x[4]*p[6][1]*(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]))/pow(pow(x[3],2.0)+pow(x[4],2.0),2.0)/sqrt(pow(p[17][1],2.0)+pow(atan2(x[4],x[3])-atan2(p[9][1],p[9][0]),2.0));
    ...
    t->cxx[18]=0.0;
    t->cxx[19]=0.0;
    t->cxx[20]=-p[6][2]*pow(x[5]-p[9][2],2.0)/pow(pow(x[5]-p[9][2],2.0)+pow(p[17][2],2.0),1.5)+p[6][2]/sqrt(pow(x[5]-p[9][2],2.0)+pow(p[17][2],2.0));
    ...
    t->cxx[25]=0.0;
    t->cxx[26]=0.0;
    t->cxx[27]=2.0*p[5][0]/pow(p[8][0],2.0);
    ...
    t->cxx[33]=0.0;
    t->cxx[34]=0.0;
    t->cxx[35]=2.0*p[5][1]/pow(p[8][0],2.0);
    ...
    t->cu[0]=2.0*u[0]*p[7][0]+2.0*p[5][0]*(u[0]-x[6])/pow(p[8][0],2.0);
    ...
    t->cu[1]=2.0*u[1]*p[7][1]+2.0*p[5][1]*(u[1]-x[7])/pow(p[8][0],2.0);
    ...
    t->cuu[0]=2.0*p[7][0]+2.0*p[5][0]/pow(p[8][0],2.0);
    ...
    t->cuu[1]=0.0;
    t->cuu[2]=2.0*p[7][1]+2.0*p[5][1]/pow(p[8][0],2.0);
    ...
    t->cxu[4]=0.0;
    t->cxu[5]=0.0;
    t->cxu[6]=-2.0*p[5][0]/pow(p[8][0],2.0);
    ...
    t->cxu[13]=0.0;
    t->cxu[14]=0.0;
    t->cxu[15]=-2.0*p[5][1]/pow(p[8][0],2.0);
