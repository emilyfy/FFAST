...
int VehicleDef::interpolate_(double speed_tps) volatile {
    if (speed_tps>0) { int lower_val = (int)speed_tps/LOOKUP_STEP_TPS*LOOKUP_STEP_TPS; }
    else { int lower_val = (int)speed_tps/LOOKUP_STEP_TPS*LOOKUP_STEP_TPS - LOOKUP_STEP_TPS; }
